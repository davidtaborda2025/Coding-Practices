...
|  Abril 13 - 2026  | Subida de archivo de R, modificaciones a 'application.py' y JS, logrando comunicación e interpretación de datos entre BD, backend, frontend y analizador de datos estadísticos.                                                                 | SQL, JavaScript, Python y R |